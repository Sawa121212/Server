(function() {
    var n = function(t, e) { return function() { return t.apply(e, arguments) } },
    ...
    this.flipchartCss = '<link href="timer.min.css?v=3" rel="stylesheet" type="text/css">', this.MegaTimer = function() {
        ...
        return r = { secundes: { max: 60, min: 0, text: "секунд", value: 0, view: !(a = null), updated: !(h = []) }, minutes: { max: 60, min: 0, text: "минут", value: 0, view: !0, updated: ![] }, hours: { max: 24, min: 0, text: "часов", value: 0, view: !0, updated: !1 }, days: { max: 1e3, min: 0, text: "дней", value: 0, view: !0, updated: !1 } }, t.prototype.destroy = function() { return null != this.interval && clearInterval(this.interval), null != this.container && (this.container.innerHTML = ""), $("#timer-" + this.id + "-style").remove(), h = [] }, t.prototype.run = function() { var t, e, i, a, s, r, n, o, l, p, m, d; if (null != this.id && (d = this.id, u.call(h, d) < 0) && (h.push(this.id), this.initView(), this.initType(), null != this.id)) { for (i in this.container = document.getElementById("timer" + this.id), e = !(this.container.innerHTML = ""), a = [], this.timerElements) a.push(i); for (a.reverse(), this.showText = this.params.design.params["text-on"], null == this.showText && (this.showText = !1), p = 0, m = a.length; p < m; p++) l = a[p], (s = document.createElement("span")).id = "timer-number-" + this.id + "-" + l, (r = document.createElement("span")).id = "timer-number-value-" + this.id + "-" + l, s.appendChild(r), (o = document.createElement("span")).id = "timer-text-" + this.id + "-" + l, o.innerHTML = this.timerElements[l].text, (t = document.createElement("span")).className = "timer-element", t.id = "timer-element-" + this.id + "-" + l, t.appendChild(s), t.appendChild(o), e ? e = !1 : ((n = document.createElement("span")).className = "timer-separator", n.id = "timer-separator-" + this.id + "-" + l, this.container.appendChild(n)), this.container.appendChild(t); return this.initDesign(), this.newTime(!0), this.interval = setInterval(this.newTime, 1e3) } }, t.prototype.initDesign = function() {
        ...
        }, t.prototype.getCssFonts = function(t) { var e, i, a, s; if (null == t && (t = ""), e = "", null != this.params.design && null != this.params.design.params && (a = this.params.design.params[t + "-font-family"], s = this.params.design.params[t + "-font-size"], i = this.params.design.params[t + "-font-color"], null != s && 0 <= parseInt(s) && (e += "font-size:" + parseInt(s) + "px;"), null != i && (e += "color:" + i + ";"), null != a)) return e + "font-family:'" + (a = null != a.family ? a.family : null) + "';" }, t.prototype.setFonts = function(t, e) { var i, a, s, r, n, o, l; if (null == e && (e = ""), null != this.params.design && null != this.params.design.params && (a = this.params.design.params[e + "-font-family"], s = this.params.design.params[e + "-font-size"], i = this.params.design.params[e + "-font-color"], null != a && (null != a.link && this.addCssLink(a.link), a = null != a.family ? a.family : null), null != t && 0 < t.length)) { for (l = [], n = 0, o = t.length; n < o; n++) r = t[n], null != s && (r.style.fontSize = parseInt(s) + "px"), null != i && (r.style.color = i), null != a ? l.push(r.style.fontFamily = a) : l.push(void 0); return l } }, t.prototype.setMargin = function(t, e) { return "auto" !== e && (e = parseInt(e) + "px"), t.style.marginBottom = e, t.style.marginLeft = e, t.style.marginRight = e, t.style.marginTop = e }, t.prototype.initView = function() { var t; return t = [1, 1, 1, 1], null != this.params && null != this.params.view && 4 === this.params.view.length && (t = this.params.view), this.timerElements.days.view = 1 === t[0], this.timerElements.hours.view = 1 === t[1], this.timerElements.minutes.view = 1 === t[2], this.timerElements.secundes.view = 1 === t[3] }, t.prototype.initType = function() {
            var t, e, i, a, s, r, n, o, l, p, m, d, h, u, c;
                ...
                switch (m = 0, o = new Date, parseInt(this.params.type.currentType)) {
                    ...
                    case 3:
                        if (null != this.params.type.params.weekdays && null != this.params.type.params.time && null != this.params.type.params.usertime && null != this.params.type.params.hours && null != this.params.type.params.minutes) {
                            for (2 === (p = this.params.type.params.time.split(":")).length && 0 <= p[0] && p[0] <= 23 && 0 <= p[1] && p[1] <= 59 || (p = [0, 0]), h = o.getDay(), l = null, s = parseInt(this.params.type.params.hours), isNaN(s) && (s = 0), r = parseInt(this.params.type.params.minutes), isNaN(r) && (r = 0), i = u = 0, c = Math.floor(parseInt(this.params.type.params.hours) / 24); 0 <= c ? u <= c : c <= u; i = 0 <= c ? ++u : --u)
                                if (--h < 0 && (h = 6), 1 === this.params.type.params.weekdays[h] && ((t = new Date).setDate(t.getDate() - i), this.params.type.params.usertime || t.setTime(t.getTime() - 6e4 * o.getTimezoneOffset() + 6e4 * this.params.type.params.tz), t.setHours(parseInt(p[0])), t.setMinutes(parseInt(p[1])), t.setSeconds(0), o.getTime() >= t.getTime() && (t.setHours(t.getHours() + s), t.setMinutes(t.getMinutes() + r), t.getTime() >= o.getTime()))) { l = t; break }(m = null) != l && (m = Math.round((l.getTime() - o.getTime()) / 1e3))
                        }
                        break;
                    default:
            ...
            var e, i, a, s;
            if (a = /^#?([a-f\d]{1,2})([a-f\d]{1,2})([a-f\d]{1,2})$/i.exec(t)) 1 === a[1].length && (a[1] += "" + a[1]), 1 === a[2].length && (a[2] += "" + a[2]), 1 === a[3].length && (a[3] += "" + a[3]), a = { r: parseInt(a[1], 16), g: parseInt(a[2], 16), b: parseInt(a[3], 16), a: 1 };
            ...
            if (o = !1, n = ["Webkit", "Moz", "O", "ms", "Khtml"], void 0 !== document.body.style.animationName && (o = !0), !o)
                for (r = 0; r < n.length;) {
                    if (void 0 !== document.body.style[n[r] + "AnimationName"]) { o = !0; break }
                    r++
                }
            if (o) {
        ...
        }, t.prototype.getIEVersion = function() { var t, e; return null != (t = window.navigator.userAgent.match(/MSIE *\d+\.\w+/i)) && 1 < (e = t[0].split(/[ \/\.]/i)).length ? parseInt(e[1]) : null }, t
    }()
}).call(this);