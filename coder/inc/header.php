...
<body>
  ...
  ?>
        ...
        <?php
          if ($_SESSION['usertype'] == 1)
          {
            echo "<li><a href='account_signup.php'>Регистрация</a></li>
				<li><a href='accounteditor/account_index.php'>Аккаунты</a></li>";
          }
        ?>
    ...
    <li class='tab'><a onclick='javascript:document.location.href=\"index.php\"' href='#'><i class ='material-icons' style='line-height: 47px;'>home</i></a></li>";
		...
		{
			echo "<li class='tab'><a onclick='javascript:document.location.href=\"mk_raspis.php\"' href='#'"; if($file_name == "mk_raspis.php"){ echo "class='active'";}	echo ">#</a></li>
					<li class='tab'><a onclick='javascript:document.location.href=\"mk_raspis_edit.php\"' href='#'"; if($file_name == "mk_raspis_edit.php"){ echo "class='active'";}	echo ">#</a></li>";
		}
	  echo "
