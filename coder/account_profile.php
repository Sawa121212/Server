  ...
  <div class="row">
    ...
    <li class="collection-item avatar">
	  ...
	  <?php echo "<p>";
		...
		echo "</p>";
		?>
      <a class="secondary-content btn blue modal-trigger" href="#modalFIO"><i class="material-icons">create</i></a>
    </li>
          <!-- FIO Modal -->
              ...
              <ul class="collection" style="width: 100%;">
                ...
                <div class="row">
                  <div class="input-field col s12 m6">      <!--Фамилия-->
                    ...
                    <input class="text" type="text" id="second_name" name="second_name" value="<?php echo @$_SESSION['second_name']; ?>">
                    <label for="second_name">Фамилия</label>
                  </div>
                  <div class="input-field col s12 m6">      <!--Имя-->
                    <i class ="material-icons prefix">account_circle</i>
                    <input class="validate" type="text" id="first_name" name="first_name" value="<?php echo @$_SESSION['first_name']; ?>">
                  ...
                  <div class="row">
                    <div class="input-field col s12 m6">    <!--Отчество-->
                      <i class ="material-icons prefix">account_circle</i>
                      <input class="text" type="text" id="patronymic" name="patronymic" value="<?php echo @$_SESSION['patronymic']; ?>">
                ...
                <div class="row center-align">
                  <div class="col s11 m6"><!--Изменить-->
                    <button class='btn blue darken-2 waves-effect waves-light z-depth-2' type='submit' name="do_editFIO">Изменить<i class='material-icons left'>border_color</i></button>
                  </div><!--/col-->
          ...
          //если кликнули на button
            if ( isset($data['do_editFIO']) )
            {
              ...
              if ( trim($data['patronymic']) == '' ){  $errors[] = "<h5>Введите Отчество</h5>";}
              ...
              if ( empty($errors) )
              {
                ...
                else{ echo "<div align='center' style='color:red; font-size:20px;'>Ошибка! Данные не изменены.</div></br>";}
              }
              else{ echo '<div align="center" id="errors" style="color:red; font-size:20px;">' .array_shift($errors). '</div><hr>';}
            }
          ?>
    ...
    <li class="collection-item avatar">
      ...
      <span class="title"><h6><b>Логин</b></h6></span>
		<?php echo "<p>";
			...
			echo "</p>";
    ?>
      <a class="secondary-content btn blue modal-trigger" href="#modalLogin"><i class="material-icons">create</i></a>
    </li>
    <!-- FIO Modal -->
              ...
              <ul class="collection" style="width: 100%;">
                ...
                <div class="row">
                  <div class="input-field col s12 m6">     <!--Логин-->
                    ...
                    <input type="text" id="nickname" class="nickname" name="login" value="<?php echo @$_SESSION['login']; ?>">
                ...
                <div class="row center-align">
                  <div class="col s11 m6"><!--Изменить-->
                    <button class='btn blue darken-2 waves-effect waves-light z-depth-2' type='submit' name="do_editLogin">Изменить<i class='material-icons left'>border_color</i></button>
                  </div><!--/col-->
          ...
          //если кликнули на button
            if ( isset($data['do_editLogin']) )
            {
              ...
              if ( empty($errors) )
              {
                ...
                $result =mssql_query("UPDATE users SET login='".$new_login."' where login='".$login."' ");
    ...
    <li class="collection-item avatar">
      ...
      <span class="title"><h6><b>Email</b></h6></span>
		<?php echo "<p>";
			...
			echo "</p>";
    ?>
      <a class="secondary-content btn blue modal-trigger" href="#modalEmail"><i class="material-icons">create</i></a>
    </li>
          <!-- Email Modal -->
              ...
              <ul class="collection" style="width: 100%;">
                ...
                <div class="row center-align">
                  <div class="input-field col s11 m6 offset-m2">   <!--Email-->
                    ...
                    <input type="email" id="email" class="validate" name="email" value="<?php echo @$_SESSION['email']; ?>">
                ...
                <div class="row center-align">
                  <div class="col s11 m6"><!--Изменить-->
                    <button class='btn blue darken-2 waves-effect waves-light z-depth-2' type='submit' name="do_editEmail">Изменить<i class='material-icons left'>border_color</i></button>
                  </div><!--/col-->
          ...
          //если кликнули на button
            if ( isset($data['do_editEmail']) )
            {
              ...
              $get_email = mysqli_query($link, "SELECT COUNT(id) FROM users WHERE email='".mssql_real_escape_string($_POST['email'])."'");
              ...
              if ( empty($errors) )
              {
                ...
                $result =mssql_query("UPDATE users SET email='".$email."' where login='".$login."' ");
                ...
                else{ echo "<div align='center' style='color:red; font-size:20px;'>Ошибка! Email не измене.</div></br>";}
              }
              else{ echo '<div align="center" id="errors" style="color:red; font-size:20px;">' .array_shift($errors). '</div><hr>';}
            }
          ?>
...
<!--Тема оформления-->
    ...
    <form action="<?php $_SERVER['PHP_SELF'] ?>" method='post'>
      <p>
        <label>
          <input class="with-gap" name="group1" value="0" type="radio" <?php if($_SESSION['thema'] == "0") echo "checked" ?> />
          <span>Светлая тема</span>
        </label>
      </p>
      <p>
        <label>
          <input class="with-gap" name="group1" value="1" type="radio" <?php if($_SESSION['thema'] == "1") echo "checked" ?> />
    ...
    ?>
    <br>
      <button class="btn blue darken-2 waves-effect waves-light z-depth-2" type="submit" name="do_editThema" >Применить<i class="material-icons left">create</i></button>
