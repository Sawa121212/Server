        ...
        <form style="width: 70%;" form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
            <div class="row">
                <div class="input-field col s12">
                    ...
                    <input class="text" type="text" id="tabel_id" name="tabel_id"
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <!--Зарегистрировать-->
                        <button class='btn darken-2  z-depth-2' type='submit' value='Зарегистрировать'
                                name='do_signup'>Зарегистрироваться
                        </button>
                    </div>
                </div>
