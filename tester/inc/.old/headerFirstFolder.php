...
<body>
      ...
      <ul id="dropdown3" class="dropdown-content">  
        <li><a href="../account/account_login.php">Войти<i class="material-icons left Tiny">airplay</i></a></li><li class="divider"></li>
      </ul>
      <!--ПК Выподающее Меню Выхода-->
      <ul id="dropdown_logoning" class="dropdown-content">  
        <li><a href="../account/account_profile.php">Профиль<i class="material-icons left Tiny">account_box</i></a></li><li class="divider"></li>
        <li><a href="../account/account_logout.php">Выйти<i class="material-icons left Tiny">exit_to_app</i></a></li></a></li><li class="divider"></li>
      </ul>
    ...
    <div class="nav-wrapper  z-depth-2">
      ...
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        ...
        <?php 
          ...
          {
            echo "<li><a href='../account/account_signup.php'>Регистрация</a></li>
  ...
  <ul class="sidenav" id="mobile-demo">
    <ul class ="blue darken-3 z-depth-1">
      <div class="row">               <!--Аккаунт-->
        ...
        <div class="input-field col s9">  
          <?php if (isset ($_SESSION['logged_user']) )
            {
              echo "<li><a href='../account/account_profile.php' style='font-size: 18px; color: white;'>" . $_SESSION['login'] . "</a></li>
                    <li><a href='../account/account_profile.php' style='font-size: 13px; color: white;'>";
              ...
              echo "</a>
                    <a href='../account/account_logout.php' style='font-size: 14px; color: white;'>Выйти</a></li>";
            }
            else 
            {
              echo "<li><a href='../account/account_login.php' style='font-size: 14px; color: white;'>Войти</a></li>";
            }
          ?>
        </div>
      </div>
    ...
    <?php if ($_SESSION['usertype'] == 1 || $_SESSION['usertype'] == 2)
    {
      ...
      echo "<li><a href='../account/account_signup.php'>Регистрация</a></li><li class='divider'></li>";
