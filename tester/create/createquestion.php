...
<body>
  ...
  <div class="container">
    <br>
    <div class="row">
      <h3 align='center'>Создание вопросов</h3>
      ...
      <form style="width: 70%;" form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
        ...
        <div class="row">
          <div class="input-field col s12">
            <!--Проверить ответы-->
            <button class='btn blue darken-2  z-depth-2' type='submit' value='Пройти заново' name='do_AddAnswer'>Добавить вариант ответа</button>
          </div>
        </div>
      </form><br>
