...
<body>
    ...
    <br>
        ...
        <div class="header-h1 header-h1-dark">
        <br/>
            <img align="center" src="../../images/kubok.jpg" width=50% height=55% alt="ПОЗДРАВЛЯЕМ!"><br/>
        
        <div class="header-h1 header-h1-dark">
            <a align="center" class="back_gamelist1" href="../../bykikorovy/html/bykikorovy_leg.php">Назад</a><br/>
        </div>
    ...
    if(isset($_POST['add']))
    {
        ...
        else
        {
            ...
            $mysqliquery = mysqli_query($conn_add, 
                "INSERT INTO topkorovkalite(usernik, score, date, time)
