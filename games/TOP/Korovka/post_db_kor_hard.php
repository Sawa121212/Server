...
<body>
    ...
    <br>
        ...
        <div class="header-h1 header-h1-dark">
            <a align="center" class="back_gamelist1" href="../../Top15Users.php">Назад</a><br/>
        </div>
...
$TESTMODE = FALSE;
    ...
    $db_table_lite = "topkorovkahard"; // имя таблицы с  которой будем работать  
...
if($TESTMODE == true){var_dump($_POST);}
    ...
    if(isset($_POST['add']))
    {
        ...
        else
        {
            ...
            $mysqliquery = mysqli_query($conn_add, 
                "INSERT INTO topkorovkahard(usernik, score, date, time)
