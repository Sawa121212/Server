...
<head>
            ...
            <script type="text/javascript" src="script/scriptMymy_hard.js"></script>

        <style type="text/css">
            * { margin: 0; padding: 0; }
           p { padding: 10px; }
           #left { position: absolute; left: 0; top: 0; width: 65%; height: 170%;}
           #right { position: absolute; right: 0; top: 0; width: 35%; height: 50%;} 
        </style>
</head>
    ...
    <div id="left">
        <div class="early_access_header12_29">
            ...
            <div class="info_div_byk">
                <p></p>
                <h2>TOP 3 игрока в Быки коровы. Тяжело</h2>
                    <?php
                        include_once("../../TOP/Korovka/db_TOP3_kor_hard.php");
                    ?>
                <p></p>
            </div>
...
<br/>
            ...
            <div class="sidebarOFF" id="saveresult">
                <div class="info_div_byk">
                    <form action="../../TOP/Korovka/post_db_kor_hard.php" method="post"><br/>
    ...
    <div id="right">        
        <div class="early_access_header12_30">
                ...
                <div class="back_div">
                    <a class="restart_game" href="bykikorovy_tych.html">Рестарт</a>
